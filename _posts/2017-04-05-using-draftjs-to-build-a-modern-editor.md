...
![Draft.js 富文本编辑器](https://infp.github.io/images/draftjs-editor.png){:.center}

那么经过 `covertToRaw` 转换的 JSON 输出有两部分组成：**blocks** 和 **entityMap**，具体结构如下：

![经过 covertToRaw 之后的编辑器内容：blocks](https://infp.github.io/images/draftjs-blocks.png){:.center}
...
![经过 covertToRaw 之后的编辑器内容：entityMap](https://infp.github.io/images/draftjs-entity.png){:.center}
